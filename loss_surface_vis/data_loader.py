...
class DatasetLoader(object):
    def __init__(
        ...
        self.tainingMag = BxBz_train
        self.testMag = BxBz_test
        ...
        self.tainingMag_tensor = None
        self.testMag_tensor = None
    ...
    def torch_tensor(self, device):
        ...
        self.tainingMag_tensor = torch.tensor(self.tainingMag).float().to(device)
        self.testMag_tensor = torch.tensor(self.testMag).float().to(device)
    ...
    def sample_data(self, train_size, val_size, test_size):
        ...
        self.tainingMag = self.tainingMag[self.train_index]
        self.testMag = self.testMag[self.test_index]
